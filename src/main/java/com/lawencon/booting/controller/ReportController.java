...
public class ReportController {
	...
	public ResponseEntity<?> ticketCompany(@PathVariable("code") String code, HttpServletResponse res){
		...
		try {
			...
			baot = jasperService.ticketCompany(listData, comp.getName() , ticketStatus, res);
		} catch (Exception e) {
			e.printStackTrace();
			return new ResponseEntity<>(e.getMessage(), HttpStatus.BAD_REQUEST);
		}
